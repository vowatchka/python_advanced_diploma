...
При работе через VM Vagrant документация Swagger доступна по адресу [http://192.168.1.33:5000/docs](http://192.168.1.33:5000/docs).
...
![компонентная схема демо-стенда](docs/imgs/demo-stand-scheme.png)
